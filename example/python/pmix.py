#! /usr/bin/env python
def usagemenu():
    print 'syntax: ./pmix.py 1:FuelID 2:Phi [3:printtype]'
    print '        FuelID    -> no. of C in the alkane (n in the formula below)'
    print '        Phi       -> equivalence ratio (0:10) for methane-air combustion'
